    ...
    const app = createApp({
      ...
      render () {
        return h(Transition, {
          ...
          default: () => visible.value && h(LoadingComponent, { ...options, fullscreen })
        })
      }
    })
...
function onDirectiveUpdate (el, { modifiers, value }) {
  if (value === false) {
    closeLoading(el)
  } else {
...
export const loadingDirective = {
  mounted: onDirectiveUpdate,
  updated: onDirectiveUpdate,
  unmounted: closeLoading
}
